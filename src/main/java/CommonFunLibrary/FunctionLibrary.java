...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser(WebDriver driver) throws Exception{
		...
		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("Chrome")){
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\sashank.QEDGE\\Desktop\\Batch81\\StockAccounting_Hybrid_MVN\\drivers\\chromedriver.exe");
			driver=new ChromeDriver();
		}else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox")){
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\sashank.QEDGE\\Desktop\\Batch81\\StockAccounting_Hybrid_MVN\\drivers\\geckodriver.exe");
			driver=new FirefoxDriver();
		}else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("ie")){
			System.setProperty("webdriver.InternetExplorer.driver", "C:\\Users\\sashank.QEDGE\\Desktop\\Batch81\\StockAccounting_Hybrid_MVN\\drivers\\IEDriverServer.exe");
